...
- a light weight R syntax using `xml_fragment` and `.tags`, creating 
...
- a named `.tags` element in which case the name is used as the tag name.
...
`.tags` have the same structure as `xml_fragment`, so you can nest them to 
